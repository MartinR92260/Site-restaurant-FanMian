	...
	<div class="section-gallery p-t-118 p-b-100">
		...
		<div class="wrap-gallery isotope-grid flex-w p-l-25 p-r-25">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				<img src="images/Boisson-1.jpg" alt="IMG-GALLERY" height="550" width="750">

				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m fa fa-search" href="images/Boisson-1.jpg" data-lightbox="gallery"></a>
				</div>
			</div>

			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				<img src="images/Repas-2.jpg" alt="IMG-GALLERY" height="550" width="750">

				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m fa fa-search" href="images/Repas-2.jpg" data-lightbox="gallery"></a>
				</div>
			</div>

			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior guests">
				<img src="images/Dessert-1.jpg" alt="IMG-GALLERY" height="550" width="750">

				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m fa fa-search" href="images/Dessert-1.jpg" data-lightbox="gallery"></a>
				</div>
			</div>

			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior">
				<img src="images/Boisson-2.jpg" alt="IMG-GALLERY" height="550" width="750">

				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m fa fa-search" href="images/Boisson-2.jpg" data-lightbox="gallery"></a>
				</div>
			</div>

			<!-- - -->
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior">
				<img src="images/Repas-10.jpg" alt="IMG-GALLERY" height="550" width="750">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events">
				<img src="images/Dessert-2.jpg" alt="IMG-GALLERY" height="550" width="750">

				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m fa fa-search" href="images/Dessert-2.jpg" data-lightbox="gallery"></a>
				</div>
			</div>
		</div>

		<div class="pagination flex-c-m flex-w p-l-15 p-r-15 m-t-24 m-b-50">
			<a href="galerie.php" class="item-pagination flex-c-m trans-0-4 active-pagination">1</a>
            <a href="galerie2.php" class="item-pagination flex-c-m trans-0-4">2</a>
		</div>
	</div>
